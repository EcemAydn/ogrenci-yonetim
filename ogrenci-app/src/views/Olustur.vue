<template>
  <div class="w-full h-full flex flex-col items-center jsutify center gap-2">
    ...
    <form class="w-2/3 md:w-1/3 rounded-md p-3 border shadow-lg">
      ...
      <div class="mb-6">
        ...
        <input 
          ...
          maxlength="11" id="tel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-blue-400" placeholder="Örn: 0507820xxxx" required>
    </div>
    <div class="mb-6">
    ...
    <div class="flex gap-2 justify-end">
      ...
      <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" @click="onSave" >Kaydet</button>
    </div>
  </form>
</div>
</template>
...
export default{
  ...
  methods: {
    // onSave() {
    //   console.log(ad);
    //   localStorage.name = this.ad;
    //   localStorage.age = this.soyad;
    //   console.log('now pretend I did more stuff...');
    // }

    onSave() {
      const dizi = localStorage.getItem
      if(localStorage.getItem('dizi')) {
